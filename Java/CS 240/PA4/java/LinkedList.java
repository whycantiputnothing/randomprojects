 ...
 *
 * !!!WARNING!!! Students are not allowed to 
 * make changes to this code. You need to use this
 * LinkedList to implement your chaining algorithm 
 * for collision detection in HashTable implementation.
 */
