...
class Run():
    def __init__(self):
        ...
        self.jvm = '/usr/lib/jvm/oracle-jdk-bin-1.7/bin/'

    def compile_java(self, filename, classpath):
        cmd = self.jvm + 'javac -classpath ' + classpath + ' ' + classpath + filename
    ...
    def run_java(self, java_class, classpath, arg):
        cmd2 = self.jvm + 'java -classpath ' + classpath + ' ' + java_class + ' ' + arg
        print cmd2
